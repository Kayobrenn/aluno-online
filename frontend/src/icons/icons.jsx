export function IconDashboard({className = "size-6"}) {
    return (
        <svg
...
export function IconAlunos({className = "size-6"}) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function IconDisciplinas({className = "size-6"}) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
...
export function IconHistorico({className = "size-6"}) {
    return (
...
export function IconProfessores() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        >
            <path
                ...
                d="M15 19.128a9.38 9.38 0 0 0 2.625.372
                   ...
                   l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12
